  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }}>
      <View style={styles.title}>
        ...
        <View style={{ alignItems: 'center', paddingTop: 15 * verticalScale, paddingBottom: 10 * verticalScale }}>
          <TouchableOpacity style={{ height: 35 * verticalScale, width: width * 0.5, backgroundColor: '#EE2222', justifyContent: 'center', alignItems: 'center', borderRadius: 8 }}>
        ...
        {/* Buttons */}
        <View style={{ flexDirection: 'row', marginBottom: 15 * verticalScale, marginLeft: 25 }}>
          <TouchableOpacity
            style={{
